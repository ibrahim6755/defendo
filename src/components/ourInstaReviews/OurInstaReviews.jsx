            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    <div className="row row-imgs py-4 px-3">
                        ...
                        <div className="col-md-6 p-0">
                            <Link to="https://www.instagram.com/defendoofficial/reels/"><img className='w-100 my-2 px-2' src={review3} alt="" /></Link>
                            <Link to="https://www.instagram.com/defendoofficial/reels/"><img className='w-100 my-2 px-2' src={review4} alt="" /></Link>
                        </div>
                    </div>
                </div>
